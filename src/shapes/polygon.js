class Polygon extends Shape {
    ...
    isInside(coordinate) {
        ...
        for (let i = 0; i < verticesCount; i++) {
            ...
            const edgeAtPointYX = ((nextX - currentX) * (y - currentY)) / (nextY - currentY) + currentX;
    ...
    convexHull() {
        ...
        let startIndex = leftIndex, endIndex;
        do {
            ...
            for (let i = 0; i < pointsCount; i++) {
                ...
                if (this.orientation(
                    [this.vertexData[startIndex * 6], this.vertexData[startIndex * 6 + 1]], 
